const HangmanImage = document.querySelector(".hungman-box img");
...
const initgame = (button, clickedLetter) => {
    //Checking if clickedLetter is not exist on the currentWord
...
// -------created keyboard buttons and adding event listeners------------
